...
const aggregatePriceHistoryByDay = (priceHistory: PriceHistoryType[]): PriceHistoryType[] => {
    ...
    try {
        ...
        switch (method) {
            case 'GET':
                ...
                const aggregatedMarketPriceHistory = aggregatePriceHistoryByDay(marketPriceHistory);
